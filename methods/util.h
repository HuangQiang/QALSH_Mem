...
extern float g_indexing_time;       // global param: indexing time
extern float g_estimated_mem;       // global param: estimated memory
...
// -----------------------------------------------------------------------------
template<class DType>
float calc_l1_dist(                 // calc Manhattan (l_1) distance
    int   dim,                          // dimension
    float threshold,                    // threshold
    const DType *p1,                    // 1st point
    const DType *p2)                    // 2nd point
